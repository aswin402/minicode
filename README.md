...
<p align="center">
  ...
  <a href="#verification--tests"><img src="https://img.shields.io/badge/Tests-96_Passing-61ffca?style=flat-square" alt="Tests" /></a>
</p>
...
* **28 Built-in Agent Tools**: Specialized primitives across web search & scraping, file editing, LSP diagnostics & code navigation, AST repository mapping, fact memories, plan workflows, git operations, and subagent delegation.
