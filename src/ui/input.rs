...
pub const PALETTE_COMMANDS: &[PaletteCommand] = &[
    ...
    PaletteCommand {
        ...
        description: "Inspect, manage, or execute Goal Anchor and Execution Ledger",
    ...
    PaletteCommand {
        ...
        description: "Interactive MiniKit multi-runtime stack wizard",
        category: CommandCategory::Tools,
        shortcut: None,
    },
    PaletteCommand {
        slash_name: "/kit",
        title: "MiniKit Tools",
        description: "MiniKit project toolkit: templates, packages, skills & drift",
        category: CommandCategory::Tools,
        shortcut: None,
    },
    PaletteCommand {
        slash_name: "/skills",
        title: "Domain Skills",
        description: "Browse domain-specific skills and architectural patterns",
        category: CommandCategory::Tools,
        shortcut: None,
    },
    PaletteCommand {
        slash_name: "/drift",
        title: "Check Drift",
        description: "Detect and self-heal architecture template drift",
        category: CommandCategory::Tools,
        shortcut: None,
    },
    PaletteCommand {
